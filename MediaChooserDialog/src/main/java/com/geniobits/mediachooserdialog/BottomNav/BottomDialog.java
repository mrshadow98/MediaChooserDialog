package com.geniobits.mediachooserdialog.BottomNav;
...
public class BottomDialog {
    ...
    private Dialog initBottomDialog(final Builder builder) {
        ...
        if (builder.btn_positive != null) {
            ...
            vPositive.setOnClickListener(view12 -> {
            ...
            if (builder.btn_colorPositiveBackground == 0) {
                ...
                builder.btn_colorPositiveBackground = !hasColorPrimary ? v.data : ContextCompat.getColor(builder.context, R.color.design_default_color_primary);
            }
        ...
        if (builder.btn_negative != null) {
            ...
            vNegative.setOnClickListener(view1 -> {
...
//
        ...
        public Builder setContent(String contentRes) {
